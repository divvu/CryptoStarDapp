...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(address1 == sender || address2 == sender, "Sender should own one of the star tokens");
        require(address1 != sender || address2 != sender, "Sender should only own one of the star tokens");
